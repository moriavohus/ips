...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return { title: titles[locale] || titles.en, description: desc[locale] || desc.en, alternates: localizedAlternates(locale, "/industries"), openGraph: { title: titles[locale] || titles.en, description: desc[locale] || desc.en } };
}
